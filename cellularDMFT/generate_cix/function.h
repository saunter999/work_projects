...
{
  SUNCA_LOG(if (N<=0) cerr << "Size of function is non positive! "<<N<<std::endl;)
...
template <class T>
inline void function2D<T>::TensorProduct(const function<T>& x, const function<T>& y, double alpha=1)
{
...
template <class T>
inline void function1D<T>::Product(const function2D<T>& A, const function<T>& x, double alpha, double beta)
{
